...
8: Attach the 140mm fan to the fan bracket (2x long M3 coarse screws)  
9: Connect HDMI and USB for the front display  
10: If you are using the included Waveshare WiFi antenna, I have a 3D printed adapter (misc section) that plugs into the ethernet port  
